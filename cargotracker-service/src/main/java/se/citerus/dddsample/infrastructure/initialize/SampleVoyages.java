...
import static se.citerus.dddsample.infrastructure.initialize.SampleLocations.*;
...
public class SampleVoyages {
    ...
    public final static Voyage v100 = new Voyage.Builder(VoyageNumber.of("V100"), HONGKONG).
        addMovement(TOKYO, toDate("2009-03-03"), toDate("2009-03-05")).
        addMovement(NEWYORK, toDate("2009-03-06"), toDate("2009-03-09")).
        build();
    public final static Voyage v200 = new Voyage.Builder(VoyageNumber.of("V200"), TOKYO).
        ...
        build();
    public final static Voyage v300 = new Voyage.Builder(VoyageNumber.of("V300"), TOKYO).
        ...
        build();
    public final static Voyage v400 = new Voyage.Builder(VoyageNumber.of("V400"), HAMBURG).
    ...
    public static final Voyage HONGKONG_TO_NEW_YORK =
        new Voyage.Builder(VoyageNumber.of("0100S"), HONGKONG).
    ...
    public static final Voyage NEW_YORK_TO_DALLAS =
        new Voyage.Builder(VoyageNumber.of("0200T"), NEWYORK).
    ...
    public static final Voyage DALLAS_TO_HELSINKI =
        new Voyage.Builder(VoyageNumber.of("0300A"), DALLAS).
    ...
    public static final Voyage DALLAS_TO_HELSINKI_ALT =
        new Voyage.Builder(VoyageNumber.of("0301S"), DALLAS).
    ...
    public static final Voyage HELSINKI_TO_HONGKONG =
        new Voyage.Builder(VoyageNumber.of("0400S"), HELSINKI).
